...
## [0.5.3](https://github.com/throgxyz/tronz/compare/v0.5.2...v0.5.3) - 2026-09-17

### Fixed

- *(primitives)* validate TRX amount input before truncation ([#69](https://github.com/throgxyz/tronz/pull/69))

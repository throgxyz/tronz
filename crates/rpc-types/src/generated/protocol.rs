// Generated by `cargo xtask codegen` from `crates/rpc-types/proto`: the `protocol` protobuf messages.
...
pub struct SmartContractDataWrapper {
    ...
    pub runtimecode: ::prost::bytes::Bytes,
    #[prost(message, optional, tag = "3")]
...
pub struct TransactionExtention {
    ...
    pub constant_result: ::prost::alloc::vec::Vec<::prost::bytes::Bytes>,
    #[prost(message, optional, tag = "4")]
